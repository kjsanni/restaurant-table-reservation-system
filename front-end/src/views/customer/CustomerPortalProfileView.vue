  ...
  <div class="page">
    <VaCard>
      ...
      <form @submit.prevent="saveProfile" class="form">
        <div class="form-row">
          <VaInput v-model="profile.firstName" label="First Name" class="form-field" />
          <VaInput v-model="profile.lastName" label="Last Name" class="form-field" />
        </div>
        <div class="form-row">
          <VaInput v-model="profile.email" label="Email" type="email" class="form-field" disabled />
