...
export const adminNavItems: NavItem[] = [
  ...
  { routeName: 'tenant-detail', text: 'Venue Details', icon: 'mdi:information', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-api-keys', text: 'API Keys', icon: 'mdi:key', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-branding', text: 'Tenant Branding', icon: 'mdi:palette', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-grace-period', text: 'Grace Period', icon: 'mdi:clock-outline', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-notes', text: 'Notes', icon: 'mdi:note-text', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-timeline', text: 'Tenant Timeline', icon: 'mdi:timeline', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-trial', text: 'Tenant Trials', icon: 'mdi:calendar-clock', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-invoices', text: 'Tenant Invoices', icon: 'mdi:file-document', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'tenant-onboarding', text: 'Tenant Onboarding', icon: 'mdi:clipboard-check', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-geographic', text: 'Geographic', icon: 'mdi:map-marker', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-alert-rules', text: 'Alert Rules', icon: 'mdi:bell-alert', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-penetration-tests', text: 'Penetration Tests', icon: 'mdi:security', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-insurance-documents', text: 'Insurance Documents', icon: 'mdi:file-certificate', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-encryption-keys', text: 'Encryption Keys', icon: 'mdi:key', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-auto-scaling', text: 'Auto Scaling', icon: 'mdi:chart-line-variant', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-compliance', text: 'Compliance', icon: 'mdi:shield-check', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-failover', text: 'Failover', icon: 'mdi:swap-horizontal', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-reconciliation', text: 'Reconciliation', icon: 'mdi:currency-usd', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-marketplace', text: 'Marketplace', icon: 'mdi:store', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-data-anonymization', text: 'Data Anonymization', icon: 'mdi:incognito', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
