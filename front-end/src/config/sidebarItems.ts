...
export const adminNavItems: NavItem[] = [
  ...
  { routeName: 'platform-support-tickets', text: 'Support Tickets', icon: 'mdi:ticket-account', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-support-templates', text: 'Support Templates', icon: 'mdi:text-box-check', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-api-latency', text: 'API Latency', icon: 'mdi:speedometer', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-cache-stats', text: 'Cache Stats', icon: 'mdi:memory', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-announcements', text: 'Announcements', icon: 'mdi:bullhorn-outline', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  { routeName: 'platform-data-retention-policies', text: 'Retention Policies', icon: 'mdi:calendar-clock', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
  ...
  { routeName: 'platform-reports', text: 'Platform Reports', icon: 'mdi:file-document-outline', requiresAuth: true, requiresPermission: 'manage_tenants', tenantOnly: true, platformOnly: true },
