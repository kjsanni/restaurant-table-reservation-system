...
const platformPaymentDAO = {};

platformPaymentDAO.getSummary = async (filters = {}) => {
  const tenantWhere = {};
  ...
  return { totals, tenants: tenantSummaries, recentPayments: recentPaymentsMapped };
};

module.exports = platformPaymentDAO;
