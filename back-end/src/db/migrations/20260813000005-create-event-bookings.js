...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex("EventBookings", ["tenantId", "eventId"]);
    await queryInterface.addIndex("EventBookings", ["customerId"]);
    await queryInterface.addIndex("EventBookings", ["paymentReference"]);
  },
