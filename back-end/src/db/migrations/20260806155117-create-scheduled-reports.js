...
const createScheduledReportsTable = async (queryInterface, Sequelize) => {
...
const addScheduledReportsIndexes = async (queryInterface) => {
...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await createScheduledReportsTable(queryInterface, Sequelize);
    await addScheduledReportsIndexes(queryInterface);
  },
