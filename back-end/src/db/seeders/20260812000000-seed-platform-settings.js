...
const DEFAULTS = [
  ...
  { key: "global_feature_flags", value: { table_management: true, waitlist: true, staff_scheduling: true, loyalty: true, pos_sync: false, salon_appointments: false, salon_walkins: false, salon_client_profiles: false, salon_whatsapp_booking: false, salon_module_enabled: false, erpnext_accounting: false, erpnext_stock: false, erpnext_crm: false, erpnext_hr: false, erpnext_pos: false, erpnext_manufacturing: false, event_guest_list: false, event_vip_lounge: false, event_table_reservation: false, event_access_control: false, event_qr_checkin: false, event_whatsapp_invites: false }, domain: "other", description: "Global default feature flags for all tenants" },
  ...
  { key: "vertical_onboarding_templates", value: [
    ...
    { id: 14, name: "VIP Lounge", vertical: "event", description: "Exclusive VIP lounge with access control, guest list, and table reservations.", defaultSettings: { restaurantType: "vip_lounge", businessVertical: "event" }, defaultServiceModes: ["vip_access", "table_reservation", "event_checkin"], featureFlags: { table_management: false, waitlist: false, staff_scheduling: true, loyalty: true, pos_sync: false, event_guest_list: true, event_vip_lounge: true, event_table_reservation: true, event_access_control: true, event_qr_checkin: true, event_whatsapp_invites: false }, createdAt: "2026-08-12T00:00:00.000Z" },
    { id: 15, name: "Conference / Exhibition", vertical: "event", description: "Conference center with ticketed entry, QR check-in, and attendee management.", defaultSettings: { restaurantType: "conference", businessVertical: "event" }, defaultServiceModes: ["ticketed_entry", "general_admission", "event_checkin"], featureFlags: { table_management: false, waitlist: false, staff_scheduling: true, loyalty: false, pos_sync: false, event_guest_list: true, event_vip_lounge: false, event_table_reservation: false, event_access_control: true, event_qr_checkin: true, event_whatsapp_invites: true }, createdAt: "2026-08-12T00:00:00.000Z" },
    { id: 16, name: "Festival Grounds", vertical: "event", description: "Multi-zone festival with general admission, VIP areas, and mobile check-in.", defaultSettings: { restaurantType: "festival", businessVertical: "event" }, defaultServiceModes: ["ticketed_entry", "vip_access", "general_admission", "event_checkin"], featureFlags: { table_management: false, waitlist: false, staff_scheduling: true, loyalty: true, pos_sync: false, event_guest_list: true, event_vip_lounge: true, event_table_reservation: false, event_access_control: true, event_qr_checkin: true, event_whatsapp_invites: true }, createdAt: "2026-08-12T00:00:00.000Z" },
    { id: 17, name: "Corporate Event", vertical: "event", description: "Corporate event with pre-registered guest list, access control, and table reservations.", defaultSettings: { restaurantType: "corporate", businessVertical: "event" }, defaultServiceModes: ["ticketed_entry", "table_reservation", "event_checkin"], featureFlags: { table_management: false, waitlist: false, staff_scheduling: true, loyalty: false, pos_sync: false, event_guest_list: true, event_vip_lounge: false, event_table_reservation: true, event_access_control: true, event_qr_checkin: true, event_whatsapp_invites: false }, createdAt: "2026-08-12T00:00:00.000Z" },
  ], domain: "other", description: "Pre-configured vertical onboarding templates for restaurant, salon, and event business types" },
];
