...
const createServer = () => {
  ...
  // codeql[js/missing-csrf-protection] Custom double-submit CSRF middleware applied below
  // codeql[js/missing-token-validation] Custom double-submit CSRF middleware applied below
