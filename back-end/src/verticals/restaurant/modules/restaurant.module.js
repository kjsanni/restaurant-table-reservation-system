...
const restaurantModule = {
  ...
  routes: [
    { path: "/api/v1/tables", router: tableRouter, middleware: [logAction, validateCsrfToken, tenantLimiter, requiredFeature("table_management")] },
    { path: "/api/v1/reservations", router: reservationRouter, middleware: [logAction, validateCsrfToken, tenantLimiter, requiresServiceMode("dine_in")] },
    { path: "/api/v1/schedule", router: scheduleRouter, middleware: [logAction, validateCsrfToken, tenantLimiter, requiredFeature("staff_scheduling")] },
    { path: "/api/v1/shifts", router: shiftRouter, middleware: [logAction, validateCsrfToken, tenantLimiter, requiredFeature("staff_scheduling")] },
    { path: "/api/v1/time-offs", router: timeOffRouter, middleware: [logAction, validateCsrfToken, tenantLimiter, requiredFeature("staff_scheduling")] },
    { path: "/api/v1/floor-plans", router: floorPlanRouter, middleware: [logAction, validateCsrfToken, tenantLimiter, requiredFeature("table_management")] },
    { path: "/api/v1/waitlist", router: waitlistRouter, middleware: [logAction, validateCsrfToken, tenantLimiter, requireVertical("restaurant"), requiredFeature("waitlist"), requiresServiceMode("dine_in")] },
    { path: "/api/v1/payments", router: paymentRouter, middleware: [logAction, validateCsrfToken, tenantLimiter] },
    { path: "/api/v1/reports", router: reportRouter, middleware: [logAction, validateCsrfToken, tenantLimiter] },
    { path: "/api/v1/menu", router: menuRouter, middleware: [logAction, validateCsrfToken, tenantLimiter] },
    { path: "/api/v1/orders", router: orderRouter, middleware: [logAction, validateCsrfToken, tenantLimiter] },
    { path: "/api/v1/promotions", router: promotionRouter, middleware: [logAction, validateCsrfToken, tenantLimiter] },
